        ...
        if (filters.location.toLowerCase() === 'india') {
          ...
          conditions.push({
            OR: [
              ...
              { location: { contains: 'Maharashtra', mode: 'insensitive' } },
              { location: { contains: 'Tamil Nadu', mode: 'insensitive' } },
              { location: { contains: 'Telangana', mode: 'insensitive' } },
              { location: { contains: 'Uttar Pradesh', mode: 'insensitive' } },
              { location: { contains: 'Kerala', mode: 'insensitive' } },
              { location: { contains: 'Gujarat', mode: 'insensitive' } },
              { location: { contains: 'Rajasthan', mode: 'insensitive' } },
              { location: { contains: 'West Bengal', mode: 'insensitive' } },
              { location: { contains: 'Haryana', mode: 'insensitive' } },
              { location: { contains: 'Andhra Pradesh', mode: 'insensitive' } },
              // More cities
              { location: { contains: 'Patna', mode: 'insensitive' } },
              { location: { contains: 'Lucknow', mode: 'insensitive' } },
              { location: { contains: 'Coimbatore', mode: 'insensitive' } },
              { location: { contains: 'Indore', mode: 'insensitive' } },
              { location: { contains: 'Nagpur', mode: 'insensitive' } },
              { location: { contains: 'Visakhapatnam', mode: 'insensitive' } },
              { location: { contains: 'Vizag', mode: 'insensitive' } },
              { location: { contains: 'Surat', mode: 'insensitive' } },
              { location: { contains: 'Vadodara', mode: 'insensitive' } },
              { location: { contains: 'Bhopal', mode: 'insensitive' } },
              { location: { contains: 'Chandigarh', mode: 'insensitive' } },
              { location: { contains: 'Mysore', mode: 'insensitive' } },
              { location: { contains: 'Mysuru', mode: 'insensitive' } },
              { location: { contains: 'Mangalore', mode: 'insensitive' } },
              { location: { contains: 'Mangaluru', mode: 'insensitive' } },
              { location: { contains: 'Bihar', mode: 'insensitive' } },
